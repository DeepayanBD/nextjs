        ...
        <div className="flex flex-col relative">
          ...
          <div className="flex flex-col md:flex-row relative max-w-screen-xl dark:text-white text-black px-4 my-10 py-8 gap-6 justify-between">
            <blockquote className="font-bold text-xl">
              ...
              <p>
                আপনার একটু সাহায্য হাসি ফুটাতে পারে হাজারো অসহায় শিশুদের মুখে।
                আপনাদের সাহায্য ও সহযোগিতায় আমরা এতদূর আসতে পেরেছি, আরো অনেক দূর
                এগিয়ে যেতে চাই।
              </p>
              <svg
                className="w-14 h-14 text-amber-500 dark:text-amber-600 my-4"
            ...
            <blockquote className="font-bold text-xl">
              ...
              <p>
                একটি ক্ষুধামুক্ত বাংলাদেশ গড়ার আমাদের এই স্বপ্ন বাস্তবায়নে
                আপনাদের সহযোগিতা ও সমর্থন আমাদের একান্ত কাম্য
              </p>
              <svg
                className="w-14 h-14 text-amber-500 dark:text-amber-600 my-4"
                aria-hidden="true"
