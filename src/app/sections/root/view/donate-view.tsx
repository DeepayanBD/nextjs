...
export default function DonateView() {
  return (
    <>
      <section className="relative px-5 md:px-10 lg:px-20 xl:px-96 mx-auto lg:py-44 py-36 bg-[url('https://www.platoform.net/assets/images/charity/bg.jpg')] bg-center bg-cover">
                ...
                <form>
                  <div className="grid grid-cols-1">
                    ...
                    <div className="mb-5">
                      ...
                      <select
                        className="form-select form-input w-full rounded-md py-3 px-4 text-sm  border-none dark:bg-slate-200"
                        aria-label="donate"
                      >
                    ...
                    <div className="mb-5">
                      <div className="flex items-center w-full mb-0">
                        ...
                        />
                        <label
                          className="form-check-label text-slate-600"
                          htmlFor="AcceptT&C"
                        >
                          I Accept{" "}
